# Dicionário de Dados - Modelo Hospitalar para ser Exportado do Sistema Hospitalar 
...
Os campos seguem a ordem exata das colunas no arquivo Excel modelo (`modelo_aih_hospital_data_do_lote.csv` – aba "LOTE").
